...
The C<new> constructor return an istance of C<Apache::Request::Redirect> object. It has four
...
It's an Apache or Apache::Request object (see also the L<"item_apachereq"|apachereq> method)
